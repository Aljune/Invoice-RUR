            ...
            <div class="col-12 border ">
                <form method="post" class="" id="Invoice">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3 ">
                                ...
                                <div class="col-md-6 form-floating mb-3 p-1">
                                    <input type="text" name="invoice_id_number" value="{{ old('invoice_id_number') }}" class="form-control"
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input type="text" class="mb-3 visually-hidden" name="customer_id" id="customer-id">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="mb-3 row test align-items-center " style="display: none">
                                        <label for="staticEmail" class="col-sm-2 col-form-label fw-bolder ">Name</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="mb-3 row test align-items-center " style="display: none">
                                        <label for="staticEmail" class="col-sm-2 col-form-label fw-bolder ">Phone Number</label>
                                        <div class="col-sm-10">
                                            <span id="customer-phone_number"></span>
                                        </div>
                                    </div>

                                    <div class="mb-3 row test align-items-center " style="display: none">
                                        <label for="staticEmail" class="col-sm-2 col-form-label fw-bolder ">Address</label>
                                        <div class="col-sm-10">
                                    ...
                                    <button type="button" class="btn border border-1 edit-customer-btn" data-bs-toggle="modal"
                                        data-bs-target="#addCustomer" style="display: none
                                ">Edit
                                        Customer</button>
                                    <button type="button" class="btn border border-1 add-customer-btn" data-bs-toggle="modal"
